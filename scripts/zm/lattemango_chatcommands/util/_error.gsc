...
{
    return array("Not enough arguments supplied", "At least " + minimumArgs + " arguments expected");
}

TooManyArgsError(maximumArgs)
{
    return array("Too many arguments supplied", "At least " + maximumArgs + "arguments expected.");
}
